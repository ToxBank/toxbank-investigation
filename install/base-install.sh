...
# Pkgs
packs="build-essential curl git-core hostname libcurl4-openssl-dev libgmp3-dev libpcre3-dev libxml2-dev libtool libglib2.0-dev libreadline-dev libssl-dev libxslt-dev ncurses-dev libraptor1-dev libyaml-dev openjdk-6-jdk unzip wget zip"
